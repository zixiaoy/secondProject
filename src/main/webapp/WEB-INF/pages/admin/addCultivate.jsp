    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('/plugIn/images/bg-01.jpg');">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                ...
                <form class="login100-form validate-form" action="addCultivate.do" method="post">
                    <span class="login100-form-title p-b-49">新建培训</span>

                    <div class="wrap-input100 validate-input m-b-23" data-validate="请输入培训名称">
                        <input class="input100" type="text" name="name" placeholder="培训名称">
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button type="submit" class="login100-form-btn">新 建</button>
                        </div>
                    </div>
